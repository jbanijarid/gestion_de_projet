...
const instance = axios.create({
  baseURL: "https://backend-api-mongod.onrender.com/api",
  timeout: 15000,
});
...
export const api = {
  ...
  creatNote: (body) => requests.post("notes", body),
  getNotesByProject: (projectId) => requests.get(`notes/project/${projectId}`),
  addNoteToProject: (projectId,body)=> requests.put(`/notes/project/${projectId}/value`,body)
};